...
public class ScoreCalculatorTests
{
    ...
    ///
    /// 旧仕様は Good=3/4 で「4 Good = 1 Miss」だった
    /// (Rhythm_game_design §2.3 で good ×1/2 に改訂)。
    /// </summary>
    [Test]
    ...
    ///
    /// 旧仕様は Great=199/200 で「50 Great = 1 Good」だった
    /// (Rhythm_game_design §2.3 で great ×90/100 に改訂)。
    /// </summary>
    [Test]
    ...
    {
        // 閾値は Rhythm_game_design §2.6 が正 (SS 995_000 / S+ 990_000 / S 970_000)
        ...
        // S (≥ 970_000)
        Assert.AreEqual("S",  ScoreCalculator.ComputeRank(970_000),   "970000  → S  lower bound");
        Assert.AreEqual("A+", ScoreCalculator.ComputeRank(969_999),   "969999  → A+ (just below S)");
