...
//   Partial-score judgments (Great = 9/10, Good = 1/2) are applied to X_micro.
...
public class ScoreCalculator
{
    ...
    /// <summary>判定 1 件分のスコアを加算する(PerfectPlus/Perfect=満点、Great=9/10、Good=1/2、Miss=0)。</summary>
    public void Add(Judgment j)
    {
        switch (j)
        {
            ...
            case Judgment.Great:       _scoreMicro += _xMicro * 9L / 10L;  break;
    ...
    /// <summary>表示スコアからランク文字列 (SS/S+/S/A+/A/B/C/D) を算出する。</summary>
